...
<div class="col-sm-6 mt-5 mx-3">
  ...
  if (isset($_REQUEST['checkid'])) {
    ...
    // Check if there's a result and if the request is assigned
    if ($result->num_rows > 0) {
        ...
        <div class="text-center">
          <form class="d-print-none d-inline mr-3"><input class="btn btn-danger" type="button" value="Print" onClick="window.print()"></form>
          <form class="d-print-none d-inline" action="CheckStatus.php"><input class="btn btn-secondary" type="submit" value="Close"></form>
        </div>
    <?php
    } else {
        // If no record found, show pending message
        echo '<div class="alert alert-dark mt-4" role="alert">
        Your Request is Still Pending. Please check back later. </div>';
    }
 }
 ?>
</div>
