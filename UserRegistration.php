  ...
  <div class="row mt-4 mb-4">
    <div class="col-md-6 offset-md-3">
      <form action="" class="shadow-lg p-4" method="POST">
        ...
        <button type="submit" class="btn btn-danger mt-5 btn-block shadow-sm font-weight-bold" name="rSignup" action="Customer/CustomerLogin.php">Sign Up</button>
...
<?php
include('Customer/includes/footer.php'); 
$conn->close();
?>